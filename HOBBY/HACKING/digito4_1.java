...
public class digito4_1 extends Thread{
	...
	public void run() {
       ...
       digito[103]=new caracteres('?');
		...
		for(int i=52;i<digito.length;i++) {
			...
			intento=Character.toString(digito[i].dime_caracter())+Character.toString(digito[j].dime_caracter())+Character.toString(digito[k].dime_caracter())+Character.toString(digito[l].dime_caracter());
