...
public class MagicSquares {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> perms=crea_combs(new ArrayList<String>(),n_elementos, r_en_r, new ArrayList<String>());
		
		
	}
	
	public static ArrayList<String> crea_combs(ArrayList<String> temporal,ArrayList<String> elementos,int r,ArrayList<String> perms) {
